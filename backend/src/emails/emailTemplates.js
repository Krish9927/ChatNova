...
export function createNewMessageEmailTemplate(recipientName, senderName, messagePreview, clientURL) {
  // Truncate long messages for the email preview
  const preview = messagePreview && messagePreview.length > 100
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width,initial-scale=1">
  <title>New Message on ChatNova</title>
</head>
<body style="margin:0;padding:0;background:#f3f4f6;font-family:Arial,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#f3f4f6;padding:32px 16px;">
    <tr><td align="center">
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;">
        ...
        <tr>
          <td style="background:linear-gradient(90deg,#2563eb,#7c3aed);padding:28px 32px;border-radius:12px 12px 0 0;">
            <p style="margin:0;color:#fff;font-size:20px;font-weight:700;">ChatNova 💬</p>
            <p style="margin:6px 0 0;color:rgba(255,255,255,0.85);font-size:14px;">New message</p>
          </td>
        </tr>
        ...
        <tr>
          <td style="background:#ffffff;padding:32px;border-left:1px solid #e5e7eb;border-right:1px solid #e5e7eb;">
            <p style="margin:0 0 12px;font-size:16px;color:#111827;">Hi <strong>${recipientName}</strong>,</p>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 24px;">
              <tr>
                <td style="background:#f1f5f9;border-left:4px solid #2563eb;padding:16px 20px;border-radius:0 8px 8px 0;">
                  <p style="margin:0;font-size:14px;color:#374151;line-height:1.5;font-style:italic;">"${preview}"</p>
                </td>
              </tr>
            </table>
...
export function createFriendRequestEmailTemplate(recipientName, senderName, clientURL) {
  return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width,initial-scale=1">
  <title>New Friend Request on ChatNova</title>
</head>
<body style="margin:0;padding:0;background:#f3f4f6;font-family:Arial,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#f3f4f6;padding:32px 16px;">
    <tr><td align="center">
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;">
        ...
        <!-- Header -->
        <tr>
          <td style="background:linear-gradient(90deg,#059669,#2563eb);padding:28px 32px;border-radius:12px 12px 0 0;">
            <p style="margin:0;color:#fff;font-size:20px;font-weight:700;">ChatNova 💬</p>
            <p style="margin:6px 0 0;color:rgba(255,255,255,0.85);font-size:14px;">New friend request</p>
          </td>
        </tr>
        ...
        <tr>
          <td style="background:#ffffff;padding:32px;border-left:1px solid #e5e7eb;border-right:1px solid #e5e7eb;">
            <p style="margin:0 0 12px;font-size:16px;color:#111827;">Hi <strong>${recipientName}</strong>,</p>
            <p style="margin:0 0 24px;font-size:15px;color:#374151;line-height:1.6;">
              <strong>${senderName}</strong> sent you a friend request on ChatNova! 🎉
            </p>

            <!-- Highlight box -->
            <table width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 24px;">
              <tr>
                <td style="background:#ecfdf5;border:1px solid #a7f3d0;padding:16px 20px;border-radius:8px;text-align:center;">
                  <p style="margin:0;font-size:15px;color:#065f46;font-weight:600;">👋 ${senderName} wants to connect with you</p>
                </td>
              </tr>
            </table>
